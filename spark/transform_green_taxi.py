...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder \
        .master("yarn") \
        .appName("Transform Green Taxi Data") \
        .getOrCreate()
    ...
    df_transformed = df \
        ...
        .withColumn("lpep_pickup_datetime", pf.col("lpep_pickup_datetime").cast(TimestampType())) \
        .withColumn("lpep_dropoff_datetime", pf.col("lpep_dropoff_datetime").cast(TimestampType())) \
        ...
        .withColumn("ehail_fee", pf.col("ehail_fee").cast(FloatType())) \
        ...
        .withColumn("trip_type", get_udf_replace(trip_type_map)(pf.col("trip_type").cast(IntegerType()))) \
        .fillna(0, subset=["ehail_fee", "improvement_surcharge", "congestion_surcharge"]) \
